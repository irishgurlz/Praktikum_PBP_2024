...
<body>
    <?php
        if (isset($_POST['submit'])){
            ...
            $alamat = test_input($_POST['alamat']); //test_input dipakai untuk inputan doang, bukan radio dll
            if (empty($alamat)){
    ...
    <form method="post">
        ...
        <div class = "form-group m-2">
            ...
            <textarea type="text" class="form-control" id="alamat" name="alamat"><?php if(isset($alamat)) {echo $alamat;}?></textarea>
    ...
    <div class="container">
        <?php
            if (isset($_POST["submit"])) { 
                if (empty($error_nama) && empty($error_email) && empty($error_alamat) && empty($error_jenis_kelamin) && empty($error_kota) && empty($error_minat)){
